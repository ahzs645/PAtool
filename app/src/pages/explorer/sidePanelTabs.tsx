...
import type { EnhancedSohIndexResult, OutlierResult, PasRecord, PatSeries } from "@patool/shared";

import { Loader, StatCard } from "../../components";
import { EChart } from "../../components/EChart";
import { useChartTheme } from "../../hooks/useChartTheme";
import { IconBuilding, IconClock, IconGauge, IconMap, IconMapPin } from "./icons";
import { formatPm25 } from "./sensorTable";
import styles from "../ExplorerPage.module.css";

export function SidePanelHomeTab({ sensor }: { sensor: PasRecord }) {
  return (
...
export function SidePanelTimeseriesTab({ sensor, patData, isLoading }: { sensor: PasRecord; patData: PatSeries | undefined; isLoading: boolean }) {
...
export function SidePanelHealthTab({ sohData, isLoading }: { sohData: EnhancedSohIndexResult | undefined; isLoading: boolean }) {
  const chartTheme = useChartTheme();
...
export function SidePanelDiagnosticsTab({ outlierData, patData, isLoading }: { outlierData: OutlierResult | undefined; patData: PatSeries | undefined; isLoading: boolean }) {
  const chartTheme = useChartTheme();
